...
0===d?"":(g=b.data,("bw"===j||"bn"===j)&&(g+="%"),("ew"===j||"en"===j)&&(g="%"+g),("cn"===j||"nc"===j)&&(g="%"+g+"%"),("in"===j||"ni"===j)&&(g=" ("+g+")"),e.errorcheck&&h(b.data,d),f=-1!==a.inArray(d.searchtype,k)||"nn"===j||"nu"===j?b.field+" "+i+" "+g:b.field+" "+i+' "'+g+'"')},this.resetFilter=function(){this.p.filter=a.extend(!0,{},this.p.initFilter),this.reDraw(),this.onchange()},this.hideError=function(){a("th.ui-state-error",this).html(""),a("error",this).hide()},this.showError=function(){a("th.ui-state-error",this).html(this.p.errmsg),a("error",this).show()},this.toUserFriendlyString=function(){return this.getStringForGroup(e.filter)},this.toString=function(){function
