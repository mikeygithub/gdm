/** layui-v1.1.0 MIT License By http://www.layui.com */
;layui.define(["layer", "laytpl", "upload"], function (i) {
    var a = "3.6.0 Pro", e = layui.jquery, t = layui.layer, n = layui.laytpl, l = layui.device(), s = "layui-show",
    ...
    layui.data.date = function (i) {
        ...
        var a = function (i) {
            return new RegExp("\\n*\\[" + (i || "") + "(pre|div|span|p|table|thead|th|tbody|tr|td|ul|li|ol|li|dl|dt|dd|h2|h3|h4|h5)([\\s\\S]*?)\\]\\n*", "g")
        };
    ...
    var x, b, w, k, C, S = function (i, a, n) {
        ...
        if (a[0]) {
            ...
            return "none" === w.css("display") && w.show(), k && t.close(k.attr("times")), 1 !== s.find("li").length || o[0] || (d || w.css("width", 800), s.css({height: w.height()}).show(), c.css("margin-left", "200px")), o[0] || (s.append(n(v).render(l)), c.append(n(f).render(l)), I(i), E()), q(s.find(".layim-chatlist-" + i.type + i.id)), o[0] || P(), D(i), Q(), C
        }
        l.first = !0;
        var u = C = t.open({
            type: 1,
    ...
    i("layim", new c)
}).addcss("modules/layim/layim.css?v=3.60Pro", "skinlayimcss");