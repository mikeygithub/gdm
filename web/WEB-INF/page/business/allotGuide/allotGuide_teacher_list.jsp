...
<div class="rightinfo">
    ...
    <form id="form1" name="form1"
          action="<%=path%>/biz/allotGuide_allotTeacherList.action?view=teacher_list&flag=01&page=${pageResult.page}"
          method="post">
        <div class="place">
            <ul class="placeul">
    ...
    <table class="tablelist">
        ...
        <s:if test="teacher.teacherId!=null">
            <tr id="tr_${model.id}">
                ...
                <td align="center">
                    <s:if test="teacher.userSex==0">女</s:if>
                    <s:if test="teacher.userSex==1">男</s:if></td>
...
<script type="text/javascript">
    // 执行选取
    function optionHandler(name, teacherId, reacherName,flag) {
        $.ajax({
            type: "post",
            cache: false,
