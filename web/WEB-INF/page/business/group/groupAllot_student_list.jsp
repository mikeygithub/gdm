...
<body>
 ...
 <div class="layui-tab">
  <ul class="layui-tab-title">
    <li  class="layui-this">
   <a  class="selected" href="<%=path%>/biz/GroupStudent_list.action?view=student_list&thisYear=${thisYear }&flag=08" >  
  ...
  <div class="layui-tab-content">
    <div class="layui-tab-item <s:if test="tabFlag!=00"> layui-show</s:if>">
		 <div class="rightinfo">
		 <form id="form1" name="form1"  action="<%=path%>/biz/GroupStudent_list.action?view=student_list&page=${pageResult.page}&flag=08" method="post">
        	...
        	<div class="place">
	        	<ul class="placeul">
	        		...
	        		<li class="click">
						...
						<li class="click">
		        		<a href="<%=path%>/biz/GroupAllot_list.action?view=list&groupType=00" ><img src="<%=path%>/images/t02.png"  style="width: 16px;"/>查看答辩组</a>
					</li>
					<li>
