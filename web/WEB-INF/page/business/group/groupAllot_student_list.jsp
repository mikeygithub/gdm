...
<div class="layui-tab">
    <ul class="layui-tab-title">
        <li class="layui-this">
            <a class="selected"
               href="<%=path%>/biz/GroupStudent_list.action?view=student_list&thisYear=${thisYear }&flag=08">
                学生列表(<font style="font-weight: bold;font-size: 14px; " color="blue">${pageResult.total }</font>)-
                答辩组</a>
        </li>
        <li>
            <a class="selected"
               href="<%=path%>/biz/GroupStudent_list.action?view=excellent_student_list&thisYear=${thisYear }&listGroupStudent.groupType=01&flag=08">
                优秀学生列表
    ...
    <div class="layui-tab-content">
        <div class="layui-tab-item  layui-show">
            <div class="">
                <form id="form1" name="form1"
                      action="<%=path%>/biz/GroupStudent_list.action?view=student_list&page=${pageResult.page}&flag=08"
                      method="post">
				    ...
				    <span>组名：<s:select cssClass="dfinput" list="groupAllotList" headerKey="" headerValue="所有组名"
                                       cssStyle="width: 130px;" onchange="$('#form1').submit();"
                                       listKey="groupId" listValue="groupName" name="model.groupAllotId"
                                       id="allGroupId"/></span>
                                </li>
                                ...
                                <s:if test="model.groupAllotId!=null">
                                    ...
                                    <s:iterator id="" value="groupAllot.directionList">
                                        <li class="click" style="font-size: 12px;">
                                            <span>${majorName } <font color="blue">&nbsp;${majorNum }&nbsp;</font>人&nbsp;</span>
                                        </li>
                                    </s:iterator>
                                    <li class="click" style="font-size: 12px;">
				    ...
				    <span>组答辩方向：<s:iterator id="" value="groupAllot.directionList">
                        <font color="blue">${majorName }&nbsp;</font>
                                    ...
                                    <li>
                                        <a href="javascript:void(0);"
                                           onclick="openGroup(this,${groupAllot.groupId},'${groupAllot.groupName }','0');">
				        ...
				        <span>院系：<s:select cssClass="dfinput" list="sysDepartmentList"
                                           ...
                                           value="listGroupStudent.deptNumber"
                                           listKey="deptNumber" listValue="deptName" name="listGroupStudent.deptNumber"
                                           id="listGroupStudent.deptNumber"/></span>
                                </li>
                                <li class="click">
                                    <span>专业</span>：<s:select cssClass="dfinput" list="sysMajorList"
                                                              value="listGroupStudent.majorId"
                                                              headerKey="" headerValue="选择专业" cssStyle="width: auto;"
                                                              onchange="$('#form1').submit();"
                                                              listKey="majorId" listValue="majorName"
                                                              id="listGroupStudent.majorId"
                                                              name="listGroupStudent.majorId"/>
                                </li>
                                <li class="click">
                                    <span>班级</span>：<s:select cssClass="dfinput" list="sysClassList"
                                                              value="listGroupStudent.classId"
                                                              headerKey="" headerValue="选择班级" cssStyle="width: auto;"
                                                              onchange="$('#form1').submit();"
                                                              listKey="classId" listValue="className"
                                                              name="listGroupStudent.classId"
                                                              id="listGroupStudent.classId"/>
                                </li>
                                <li class="click" style="font-size: 12px">
		        		<span>学生姓名:
	        		    <input type="text" class="dfinput" id="selectValue" name="listGroupStudent.stuName"
                               placeholder="学生姓名"></span>
                                ...
                                <li class="click">
                                    <a href="javascript:void();" onclick="openSearch(this);"><img
                                            src="<%=path%>/images/search.png"/>搜索</a>
                                </li>
                                <li class="click">
                                    <a href="<%=path%>/biz/GroupAllot_list.action?view=list&groupType=00"><img
                                            src="<%=path%>/images/t02.png" style="width: 16px;"/>查看答辩组</a>
                                </li>
                                <li>
        ...
        <%--        <div class="layui-tab-item <s:if test="tabFlag==00"> layui-show</s:if>"></div>--%>
...
<script type="text/javascript">
    ...
    function option(name, stuId, stuName) {
        ...
        var index = layer.confirm(allGroupName + '<br>您确定选择 以下学生吗?<br><font color=\'blue\'>' + stuName + '</font>', {
            icon: 3,
            title: '提示'
        }, function (index) {
            layer.close(index);
