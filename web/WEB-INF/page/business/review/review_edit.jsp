	...
	<div class="rightinfo" style=" width: 980px;margin: 0 auto;">
		...
		<s:if test="thisReviewType==02">
			...
			<div class="layui-field-box">
				...
				<form
					action="<%=path%>/biz/review_edit.action?view=detail"
					...
					<input type="hidden" name="thisReviewType" value="${thisReviewType }" >	
...
<%--									<s:property value="review.reviewScoreList"></s:property>--%>
										...
										<tr class="title">
											...
											<s:iterator id="ps" value="scoreItemList" status="sp">
												<s:if test="#sp.count<=1">
													...
													<td align="center">
													<input class="dfinput" style="width: 50px" min="0" 
													      name="score" 
													    id="${scoreItemId }"
									...
									<td align="center">${review.totalScore }</td>
						         	...
						         	<tr class="title">
									<td align="left" >
									<s:if test="thisReviewType==00|thisReviewType==02">指导教师评语:</s:if>
									<s:if test="thisReviewType==01">评阅教师评语:</s:if>
