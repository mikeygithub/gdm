...
<%--                        <form action="<%=path%>/biz/openReport_add.action?view=detail" method="post" name="form1" id="form1">--%>
                        <form action="<%=path%>/biz/openReport_add.action?view=edit" method="post" name="form1" id="form1">
