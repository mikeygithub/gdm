...
<body style="min-width: 200px">
     ...
     <form id="form1" name="form1"  action="<%=path%>/biz/issueInfo_info.action?view=add&page=${pageResult.page}" method="post">
        <div class="place">
			<ul class="placeul">
    ...
    <div class="layui-field-box" >
		<form 
		    action="<%=path%>/biz/issueInfo_add.action?view=edit" 
