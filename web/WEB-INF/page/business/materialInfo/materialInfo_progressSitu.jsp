    ...
    <div class="formbody">
        <div id="usual1" class="usual">
                    ...
                    <ul>
                        <li class="line">
                            <s:if test="pageResult1.data!=null&&pageResult.total>0">
                                <a href="<%=path%>/biz/progressSitu_outProgressSitu.action?thisStuId=${thisStuId }&thisYear=${thisYear }"><font>
                                    <img src="<%=path%>/images/i01.png" width="20px"/>一键导出</font></a>
                            </s:if>
                            <s:else>
                                <a href="javascript:layer.msg('数据为空', {icon: 2});;"><font>
                                    <img src="<%=path%>/images/i01.png" width="20px"/>一键导出</font></a>
                            </s:else>
                        </li>
                    </ul>
            ...
            <table class="tablelist fix-table">
                ...
                <s:else>
                    <tr>
                        <td colspan="6" align="center"><font>暂无</font></td>
                    </tr>
                </s:else>
