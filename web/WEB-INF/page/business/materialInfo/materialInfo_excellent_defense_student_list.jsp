...
<body>
        ...
        <form id="form1" name="form1"  action="<%=path%>/biz/materialInfo_groupDefenseStudentList.action?view=excellent_defense_student_list&flag=13&thisReplyType=01" method="post">
        	<div class="place">
		<ul class="placeul">
