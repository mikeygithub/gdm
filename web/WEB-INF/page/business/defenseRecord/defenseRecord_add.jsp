...
<head>
    ...
    <script type="text/javascript">
        ...
        //     onkeyup: false,
        //     submitHandler: function (forms) {   //表单提交句柄,为一回调函数，带一个参数：form
        ...
        function getData() {
            $("#defenseProblem").val(getPro());
            $("#defenseAnswer").val(getAnsw());
        }

        function addDefenseRecord() {
            var val = document.getElementById('model.defenseContent').value;
                ...
                <fieldset class="layui-elem-field">
                    ...
                    <div class="layui-field-box">
                        <div class="formtitle" style="float:right;">
                            <ul>
                                <li class="line"><a
                                        href="<%=path%>/biz/defenseRecord_outDefenseRecord.action?thisId=${model.defenseId }">
                            ...
                            <ul>
                                <li>
                                    ...
                                    >
                                        ...
                                        <tr>
                                            <td colspan="10">
                                                <div>
                                                    <textarea name="model.defenseContent" id="model.defenseContent"
                                                              cols="" rows="" class="textinput"
                                                              style="width: 100%">${model.defenseContent}</textarea>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <li>
                                    <div style="text-align: center;">
                                        <input name="" type="button" class="scbtn" onclick="addDefenseRecord()"
                                               value="保存"/>
                                    </div>
                                </li>
                            </ul>
