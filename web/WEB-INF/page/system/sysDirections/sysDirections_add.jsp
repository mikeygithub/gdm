	 ...
	 $(function(){
	    ...
	    $("#form1").validate({
	        ...
	        submitHandler: function(form){   //表单提交句柄,为一回调函数，带一个参数：form
				layer.confirm('您确定要保存 '+$("input[name='model.directionsName']").val()+' 吗?', {icon: 1, title:'提示'}, function(){
	        ...
	        rules:{
	        	"model.directionsName":{
	                required:true,
	                remote: {  
		                type: "post",  
		                url: "<%=path %>/sys/directions_checkName.action",  
		                data: {  
		                    "model.directionsName": $("#model.directionsName").val()  
		                },  
		                dataType: "html",  
...
<body style="min-width: 200px">
  ...
  <div class="layui-field-box">
		<form action="<%=path%>/sys/directions_add.action?view=add"
					...
					<table  border="10" cellspacing="0" cellpadding="0" width="100%"
						...
						<tr >
							...
							<td ><input type="text" class="inputfrom"
								id="model.directionsName" name="model.directionsName"> <i class="warn">*</i></td>
						</tr>
						<tr >
	                   <!-- <tr >
