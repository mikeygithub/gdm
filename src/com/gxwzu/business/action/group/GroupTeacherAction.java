 ...
 * 
 */
public class GroupTeacherAction extends BaseAction implements
		ModelDriven<GroupTeacher> {

	private static final long serialVersionUID = -3343014949806289390L;
	protected final Log logger = LogFactory.getLog(getClass());
	protected static final String TEALIST_JSP = "teacher_list";
	...
	public String list() {
		...
		if(flag!=null&&"08".equals(flag)){
			...
			if(listGroupTeacher.getGroupType()==null){
				listGroupTeacher.setGroupType("00"); //默认为答辩组
			}
			/*************************** end *******************************************/
			...
			if (thisTeacherId != null && teachType != null&& thisGroupId != null) {
				...
				if (groupAllot != null) {
					...
					if(!teachType.equals("1")){  //0-组长 1-答辩老师  2-记录员 
					  gTeacher = groupTeacherService
							.findByGroupIdAndTypeAndYear(thisGroupId,
									teachType, planYear.getYear());
					}
	...
	public void delSelTeacher() throws Exception {
		...
		if (thisTeacherId != null && thisYear != null && thisGroupId != null) {
			ListGroupTeacher gTeacher = groupTeacherService
					.findByGroupAllotIdAndTeacherIdAndYear(thisGroupId,
							thisTeacherId, thisYear);
