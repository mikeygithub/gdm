...
<body style="min-width: 200px">
  ...
  <div class="layui-field-box">
		<form action="<%=path%>/sys/major_add.action"
				...
				<li>
        		 ...
        		 listKey="deptNumber" listValue="deptName" onchange="onSelect(this);"
                  ...
                  <i class="warn">*</i> </td>
							...
							<td >
        		      <select class="dfinput" id="categoryList" listKey="deptNumber"name="model.categoryId"  >
                  ...
                  <i class="warn">*</i> </td>
						...
						<tr >
							...
							id="model.majorName" name="model.majorName"> <i class="warn">*</i></td>	
						</tr>
						<tr >
							<td  class="rightText" >教研室：</td>
							<td ><input type="text" class="dfinput"
							id="model.staffName" name="model.staffName"> <i class="warn">*</i></td>	
						</tr>
					</table>
				<li>
