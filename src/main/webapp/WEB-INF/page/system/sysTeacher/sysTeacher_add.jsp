	 ...
	 $(function(){
		    ...
		    $("#form1").validate({
		        ...
		        submitHandler: function(form){   //表单提交句柄,为一回调函数，带一个参数：form
					layer.confirm('您确定要保存 '+$("input[name='model.teacherName']").val()+' 吗?', {icon: 1, title:'提示'}, function(){
	...
	<div class="main">
		<fieldset class="layui-elem-field">
			...
			<div class="layui-field-box">
				<form action="<%=path%>/sys/teacher_add.action?view=add"
										...
										name="staffroomId">
											<s:iterator id="sm" value="sysMajorList">
												<option value="${majorId }"
													<s:if test="majorId==model.staffroomId">selected="selected"</s:if>>${staffName }</option>
											</s:iterator>
									</select>
										<i class="warn">*</i>
									</td>
