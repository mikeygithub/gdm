...
<div class="layui-tab">
    <ul class="layui-tab-title">
        <li>
            <a class="selected"
               href="<%=path%>/biz/GroupStudent_list.action?view=student_list&thisYear=${thisYear }&listGroupStudent.groupType=00&flag=08">
                学生列表
        ...
        <div class="layui-tab-item <s:if test="tabFlag!=00"> layui-show</s:if>">
            <div class="rightinfo">
                <form id="form1" name="form1"
                      action="<%=path%>/biz/GroupStudent_list.action?view=excellent_student_list&page=${pageResult.page}&listGroupStudent.groupType=01&flag=08"
                      method="post">
				    ...
				    <span>组答辩方向：<s:iterator id="" value="groupAllot.directionList">
	        		    ...
	        		    <input type="text" class="dfinput" id="selectValue" name="listGroupStudent.stuName"
                               placeholder="学生姓名"></span>
                                ...
                                <li class="click">
                                    <a href="<%=path%>/biz/GroupAllot_list.action?view=list&groupType=01"><img
                                            src="<%=path%>/images/t02.png" style="width: 16px;"/>查看大组</a>
                                </li>
                                <li>
