...
<div class="layui-tab">
    <ul class="layui-tab-title">
        <li>
            <a class="selected"
               href="<%=path%>/biz/GroupTeacher_list.action?view=teacher_list&thisYear=${thisYear }&flag=08">
                教师列表(<font style="font-weight: bold;font-size: 14px; " color="blue">${pageResult.total }</font>)-
                答辩组</a>
        </li>
        <li class="layui-this">
            <a class="selected"
               href="<%=path%>/biz/GroupTeacher_list.action?view=excellent_teacher_list&thisYear=${thisYear }&flag=08">
        ...
        <div class="layui-tab-item layui-show">
            <div class="rightinfo">
                ...
                <form id="form1" name="form1"
                      action="<%=path%>/biz/GroupTeacher_list.action?view=excellent_teacher_list&page=${pageResult.page}&listGroupTeacher.groupType=01&flag=08"
                      method="post">
                    <div class="place">
                        <ul class="placeul">
			        ...
			        <span>院系：<s:select cssClass="dfinput" list="sysDepartmentList"
                                       cssStyle="width: auto;" onchange="$('#form1').submit();"
                                       listKey="deptNumber" listValue="deptName" name="listGroupTeacher.deptNumber"
                                       id="listGroupTeacher.deptNumber"/></span>
                            </li>
                            <li class="click" style="font-size: 12px">
			        <span>大类：<s:select cssClass="dfinput" list="sysCategoryList"
                                       headerKey="" headerValue="所有大类"
                                       cssStyle="width: auto;" onchange="$('#form1').submit();"
                                       listKey="categoryId" listValue="categoryName" name="listGroupTeacher.categoryId"
                                       id="listGroupTeacher.categoryId"/></span>
                            </li>
                            <li class="click" style="font-size: 12px">
	        		<span>教研室：<s:select cssClass="dfinput" list="sysMajorList"
                                        cssStyle="width: auto;" onchange="$('#form1').submit();"
                                        headerKey="" headerValue="所有教研室"
                                        listKey="majorId" listValue="staffName" name="listGroupTeacher.staffroomId"
                                        id="listGroupTeacher.staffroomId"/>
                           ...
                           placeholder="教师姓名"></span>
                            ...
                            <li class="click">
                                <a href="<%=path%>/biz/GroupAllot_list.action?view=list&groupType=01"><img
                                        src="<%=path%>/images/t01.png" style="width: 16px;"/>查看分组</a>
                            </li>
                            </li>
                            <li class="click">
                                <a href="javascript:void(0);" onclick="openGroup();"><img src="<%=path%>/images/t01.png"
                                                                                          style="width: 16px;"/>添加大组</a>
                            </li>
                        </ul>
                    </div>
                </form>
                <table class="tablelist">
                    ...
                    <s:iterator id="p" value="pageResult.data" status="pp">
                        <tr id="tr_${teacherId}">
                            ...
                            <td align="center">
                                <s:if test="deptName==null||deptName==''">
                                    <font>-</font>
                                </s:if>
                                <s:else>
                                    ${deptName}
                            ...
                            <td align="center">
                                <s:if test="categoryName==null||cateoryName==''">
                                    <font>-</font>
                                </s:if>
                                <s:else>
                                    ${categoryName }
                            ...
                            <td align="center">
                                <s:if test="staffName==''||staffName==null">
                                    <font>-</font>
                                </s:if>
                                <s:else>
                                    ${staffName}
