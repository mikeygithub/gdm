...
<body>
<div class="layui-layer layui-layer-page layui-box layui-layim-chat layer-anim" id="layui-layer100006" type="page"
     times="100006" showtime="0" contype="string" style="z-index: 19991020; width: 100%; top: 0; left: 0; min-width: 100px;
    ...
    <div id="layui-layim-chat" class="layui-layer-content"
         style="right: 0;bottom: 0; left: 0;position: absolute;top: 0;z-index: -4;">
            ...
            <div class="layim-chat layim-chat-friend layui-show"
                ...
                <div>
                    <div class="layim-chat-other">
                        ...
                        <p class="layim-chat-status"><span
                                style="color:#FF5722;">${teacherList.staffName } ${student.majorName }</span></p>
                    </div>
                </div>
...
<%--                            <span id="closechat" class="layim-send-close">关闭</span>--%>
                            <span id="sendchat" class="layim-send-btn"
                                  onclick="loadAddChat(this,${thisId},'${teacherList.teacherName }${student.stuName }');">发送</span>
                        </div>
                    </div>
                    <!--按钮end  -->
                </div>
            ...
            $.post('<%=path%>/biz/chatInfo_load' + pro + 'ChatMessageList.action?thisId=${thisId}&thisType=${thisType}&chatType=${chatType}', function (res) {
                ...
                $.each(result.obj, function (index, con) {
				   ...
				   alert(a+","+con.senderId);  */
                        ...
                        /* if('
                        ${model.senderId}'==con.senderId||'
                        ${model.senderId}'==con.anwserId){
				     timechat_li =  $(' <li id=\"chatId_'+con.chatId+'\" class="layim-chat-mine"></li>');
				  } */
