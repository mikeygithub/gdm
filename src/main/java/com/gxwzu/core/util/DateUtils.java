...
public class DateUtils {
    ...
    public final static DateFormat DEFAULT_LONG_TIME_FORMATER = new SimpleDateFormat(DEFAULT_TIMES_FORMAT);
    ...
    public static String formatLongTime(Date date) {
        ...
        return DEFAULT_LONG_TIME_FORMATER.format(date);
    }

    public static String timestampFormatTime(Timestamp timestamp) {
        if (timestamp == null) {
            return null;
        }
        return DEFAULT_TIME_FORMATER.format(timestamp);
    }
