...
<script type="text/javascript">
 	$(document).ready(function(){
		...
		var keepMajorId = $("#keepMajorId").attr("value");//后台传回来的值
		var keepClassId = $("#keepClassId").attr("value");//后台传回来的值
		
		var selMajorId = document.getElementById("majorList");
        for(var i = 0; i < selMajorId.length; i++) {
            if(selMajorId.options[i].value == keepMajorId) {
            	selMajorId.selectedIndex = i;
            	break;
          	}
        }
        
        var selClassId = document.getElementById("classList");
        for(var i = 0; i < selMajorId.length; i++) {
            if(selClassId.options[i].value == keepClassId) {
            	selClassId.selectedIndex = i;
            	break;
          	}
        }
	...
	<div class="main">
		<fieldset class="layui-elem-field">
			...
			<div class="layui-field-box">
				<form action="<%=path%>/sys/student_edit.action?view=edit"
						...
						<li>
							<table class="tablelist" width="100%">
								...
								<tr>
										...
										<td style="font-size: 16px;padding: 4px;color: #3EAFE0;">${student.stuNo }
