...
function openGroup(){
	...
	trData2.appendTo(tableData);
	  ...
	  var index = layer.confirm(''+tableData[0].outerHTML, {title:'添加答辩组'}, function(index){
			 var categoryIds ="";
			...
			addGroup(categoryIds,$('#groupAllotName').val(),'00','${listGroupTeacher.deptNumber}',index);
	   });
}
</script>
<script type="text/javascript">
...
<body>
  ...
  <ul class="layui-tab-title">
   ...
   <a  class="selected" href="<%=path%>/biz/GroupTeacher_list.action?view=teacher_list&thisYear=${thisYear }&flag=08" >  
    ...
    <li>
    <a  class="selected" href="<%=path%>/biz/GroupTeacher_list.action?view=excellent_teacher_list&thisYear=${thisYear }&listGroupTeacher.groupType=01&flag=08" >  
  ...
  <div class="layui-tab-content">
    <div class="layui-tab-item layui-show">
		<div class="rightinfo">
		 ...
		 <form id="form1" name="form1"  action="<%=path%>/biz/GroupTeacher_list.action?view=teacher_list&page=${pageResult.page}&flag=08" method="post">
      <div class="place">
        	<ul class="placeul">
	...
	<div class="place">
        <ul class="placeul">
        		...
        		<li class="click">
					...
					<li class="click">
	        		<a href="<%=path%>/biz/GroupAllot_list.action?view=list&groupType=00" ><img src="<%=path%>/images/t01.png"  style="width: 16px;"/>查看分组</a>
				</li>
				</li>
					<li class="click">
	        		<a href="javascript:void(0);"  onclick="openGroup(this);" ><img src="<%=path%>/images/t01.png"  style="width: 16px;"/>添加答辩组</a>
				</li>
			</ul>
		</div>
			</form>
