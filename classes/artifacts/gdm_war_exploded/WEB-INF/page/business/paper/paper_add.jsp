   ...
   <div class="rightinfo" style="text-align: center;">
    ...
    <div class="layui-field-box" >
    	<%--<div class="formtitle" >
			<ul>
			    <li class="line">
				    <a href="<%= basePath%>/biz/taskBook_uploadTaskBook.action?thisId=${model.paperId }">
				    <font> <img src="<%=path%>/images/ico04.png" width="20px" />论文上传</font></a>
				</li>
				<li class="line"> 
					<a href="<%=path%>/biz/taskBook_outTaskBook.action?thisId=${model.paperId }">
					<font> <img src="<%=path%>/images/i01.png" width="20px" />一键导出</font></a>
				</li>
			</ul>
		</div> 
